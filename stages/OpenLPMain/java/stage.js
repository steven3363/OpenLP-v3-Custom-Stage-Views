...
var intfadein = 300;
var intfadeout= 300;
//Select one song format by removing and adding '//'
//var mycursong="lowerthird-shadow";
//var mycursong="lowerthird";
//these are set by using the python helper program updatetheme.py
...
window.OpenLP = { // Connect to the OpenLP Remote WebSocket to get pushed updates
  ...
  updateSlide: function() {
    ...
    text = text.replace(/\n/g, "<br />");
       ...
       console.log("Script Songs");
    if (OpenLP.curPlugin === 'songs') {
    	
    	//make sure correct background
    	var element = document.querySelector("#bgslide");
  	element.className = mycursong + "slide"; //
    	//set correct formatting for slide
    	var element = document.querySelector("#currentslide");
    	element.className = mycursong + "currentslide"; //
    	var element = document.querySelector("#songtitle");
    	element.style.display = "none";
  	
    } 
    console.log("Script Bibles");
    // set bible css
    if (OpenLP.curPlugin === 'bibles') {
    	
    	//make sure correct background
    	var element = document.querySelector("#bgslide");
  	element.className = mycurbible + "slide"; //
    	//set correct formatting for slide
    	var element = document.querySelector("#currentslide");
    	element.className = mycurbible + "currentslide"; //
    	var element = document.querySelector("#songtitle");
    	element.style.display = "block";
  	element.className = mycurbible + "songtitle"; //
    } 
